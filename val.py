...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='pretrained_val') 
    ...
    # checkpoint_dir = 'lightning_logs/version_14/checkpoints/' # av1 14
    ...
    val_dataset = ArgoverseV1Dataset_models(args.root, args.split, args.processed_root, \
